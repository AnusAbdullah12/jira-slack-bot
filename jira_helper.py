...
JIRA_API_URL = EnvironmentSettings.get_jira_api_url()
JIRA_API_TOKEN = EnvironmentSettings.get_jira_api_token()
JIRA_USER = EnvironmentSettings.get_jira_user_email()
...
def _get_jira_user_id_by_email(email):
    ...
    return '712020:20617021-040e-4b29-9098-73d5de0a0b04'
...
def get_sprint_issues(sprint_id):
    """Fetches issues for a given Sprint ID."""
    url = f"{JIRA_API_URL}/sprint/{sprint_id}/issue"
